...
public:
  ...
  static constexpr auto SETTING_VIDEOPLAYER_3DEXTERNALPLAYER =
      "videoplayer.3dexternalplayer";
  static constexpr auto SETTING_VIDEOPLAYER_3DEXTERNALPLAYERVFS =
      "videoplayer.3dexternalplayervfs";
  ...
  static constexpr auto SETTING_VIDEOPLAYER_USEMEDIACODECHYBRIDSURFACE =
      "videoplayer.usemediacodechybridsurface";
  ...
  static constexpr auto SETTING_VIDEOSCREEN_GUIHDRSURFACE = "videoscreen.guihdrsurface";
  ...
  static constexpr auto SETTING_WEBDAV_EXTRACTINFO = "webdav.extractinfo";
  ...
  static constexpr auto SETTING_AUDIOOUTPUT_DOLBYATMOSDECODING = "audiooutput.dolbyatmosdecoding";
